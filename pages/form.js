                ...
                <div>
                  ...
                  <TextField
                    ...
                    error={
                      !/^\d*\.?\d*$/.test(a) || 
                      parseFloat(a) <= 0 || 
                      parseFloat(a) >= parseFloat(metamaskBalance) || 
                      parseFloat(a) < Math.pow(10, -18)
                    }
                    helperText={
                      !/^\d*\.?\d*$/.test(a) ? "Only positive numbers are allowed" :
                      parseFloat(a) >= parseFloat(metamaskBalance) ? "Amount must be less than the account balance" :
                      parseFloat(a) < Math.pow(10, -18) ? "Amount must be greater than or equal to 10^-18" 
                      : "" 
                    }
                  />
                  <br /><br />
                  ...
                  />
                  <Typography>(For example: if amount=10, multiplier=0.9, and 3rd user got paid 10; the 4th user will be paid 10*0.9= 9)</Typography>
